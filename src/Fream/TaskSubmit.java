...
public class TaskSubmit extends JFrame {
	 ...
	 */
	public static void GetTaskSubmit() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TaskSubmit frame = new TaskSubmit();
	...
	public TaskSubmit() {
		...
		JLabel label = new JLabel("任务提交信息");
